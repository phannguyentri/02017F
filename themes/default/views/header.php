...
<head>
    ...
    <link href="<?= $assets ?>styles/TimeSheet.css" rel="stylesheet"/>
                ...
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_1" style="display: none;">
                                <a class="dropmenu" href="#"><i class="fa fa-barcode"></i><span
                                        class="text">Danh mục</span> <span
                                        class="chevron closed"></span></a>
                                <ul>
                                    <li id="mm_1_1"><a class="submenu" href="<?= site_url('products'); ?>"><i
                                                class="fa fa-barcode"></i><span
                                                class="text" style="text-decoration: underline;">Thành phẩm</span></a></li>
                                    <li id="mm_1_2"><a class="submenu" href="<?= site_url('products/add'); ?>"><i
                                                class="fa fa-plus-circle"></i><span
                                                class="text" style="text-decoration: underline;">Vật tư</span></a></li>
                                    <li id="mm_1_3"><a class="submenu"
                                                               href="<?= site_url('products/print_barcodes'); ?>"><i
                                                class="fa fa-tags"></i><span
                                                class="text" style="text-decoration: underline;">Nhân viên</span></a></li>
                                    <li id="mm_1_4"><a class="submenu"
                                                                      href="<?= site_url('products/print_labels'); ?>"><i
                                                class="fa fa-tags"></i><span
                                                class="text" style="text-decoration: underline;"
                                                >Khách hàng</span></a></li>
                                    <li id="mm_1_5"><a class="submenu"
                                                                    href="<?= site_url('products/import_csv'); ?>"><i
                                                class="fa fa-file-text"></i><span
                                                class="text">Kho</span></a></li>
                                    <li id="mm_1_6"><a class="submenu"
                                                                      href="<?= site_url('products/update_price'); ?>"><i
                                                class="fa fa-money"></i><span
                                                class="text" style="text-decoration: underline;">Xưởng</span></a></li>
                                </ul>
                            </li>
                         <!--    Khai bao danh mục -->
                            <li class="mm_items">
                                <a class="dropmenu" href="#"><i class="fa fa-table"></i><span
                                        class="text"> <?= lang('Khai báo danh mục'); ?> </span> <span
                                        class="chevron closed"></span></a>
                                <ul>

                                        <li id="mm_items_categories"><a
                                                href="<?= site_url('categories') ?>"><i
                                                    class="fa fa-archive sub-menu-margin"></i><span
                                                    class="text">Loại máy móc</span></a></li>
                                        <li id="mm_items_machine"><a
                                                href="<?= site_url('machine') ?>"><i
                                                    class="fa fa-archive sub-menu-margin"></i><span
                                                    class="text">Danh sách máy móc</span></a></li>
                                        <li id="system_settings_categories"><a
                                                href="<?= site_url('units') ?>"><i
                                                    class="fa fa-folder-open sub-menu-margin"></i><span
                                                    class="text">Đơn vị tính</span></a></li>
                                          <li id="system_settings_categories"><a
                                                href="<?= site_url('working_places') ?>"><i
                                                    class="fa fa-building sub-menu-margin"></i><span
                                                    class="text">Xưởng</span></a></li>
                                        <li id="system_settings_warehouses"><a
                                                href="<?= site_url('system_settings/warehouses') ?>"><i
                                                    class="fa fa-building-o sub-menu-margin"></i><span
                            ...
                            <li class="mm_items">
                                <a class="dropmenu" href="#"><i class="fa fa-cubes"></i><span
                                        ...
                                        class="chevron closed"></span></a>
                                <ul>
                                    <li id="items_index"><a class="submenu" href="<?= site_url('items'); ?>"><i
                                                class="fa fa-th-list sub-menu-margin"></i><span
                                                class="text"> <?= lang('Danh sách nguyên vật liệu'); ?></span></a></li>
...
<!--                                     <li id="products_sheet"><a class="submenu"
                           ...
                           <!--  Yêu cầu sản xuất -->
                            <li class="mm_productions">
                                <a class="dropmenu" href="#"><i class="fa fa-barcode"></i><span
                                        class="text"> <?= lang('Đơn hàng sản xuất'); ?> </span> <span
                                        class="chevron closed"></span></a>
                                <ul>
                                    <li id="productions_index"><a class="submenu" href="<?= site_url('productions'); ?>"><i
                                                class="fa fa-barcode sub-menu-margin"></i><span
                                                class="text"> <?= lang('Danh sách lệnh sản xuất'); ?></span></a></li>

                                    <li id="productions_add"><a class="submenu" href="<?= site_url('productions/add'); ?>"><i
                                                class="fa fa-plus-circle sub-menu-margin"></i><span
                                                class="text"> <?= lang('Thêm lệnh sản xuất'); ?></span></a></li>
                                </ul>
                            </li>
                        <!--  Yêu cầu mua hàng -->
                          <li class="mm_enquiry">
                                <a class="dropmenu" href="#"><i class="fa fa-barcode"></i><span
                                        class="text"> <?= lang('Yêu cầu mua hàng'); ?> </span> <span
                                        class="chevron closed"></span></a>
                                <ul>
                                    <li id="enquiry_index"><a class="submenu" href="<?= site_url('enquiry'); ?>"><i
                                                class="fa fa-barcode sub-menu-margin"></i><span
                                                class="text"> <?= lang('DS yêu cầu mua hàng'); ?></span></a></li>

                                    <li id="enquiry_add"><a class="submenu" href="<?= site_url('enquiry/add'); ?>"><i
                                                class="fa fa-plus-circle sub-menu-margin"></i><span
                                                class="text"> <?= lang('Thêm yêu cầu mua hàng'); ?></span></a></li>
                                </ul>
                            </li>
                           <!--  -->

                            <li class="mm_quotes" style="display: none;">
                                ...
                                <ul>
                                    ...
                                    <li id="quotes_index"><a class="submenu" href="<?= site_url('quotes'); ?>"><i
                                                class="fa fa-heart-o sub-menu-margin"></i><span
                            ...
                            <li class="mm_purchases">
                                ...
                                <ul>
                                    ...
                                    <li id="purchases_index"><a class="submenu" href="<?= site_url('purchases'); ?>"><i
                                                class="fa fa-star sub-menu-margin"></i><span
                            ...
                            <li class="mm_transfers" style="display: none;">
                                ...
                                <ul>
                                    ...
                                    <li id="transfers_index"><a class="submenu" href="<?= site_url('transfers'); ?>"><i
                                                class="fa fa-star-o sub-menu-margin"></i><span
                                ...
                                <ul>
                                    <li id="timekeepers_view">
                                        <a class="submenu" href="<?= site_url('timekeepers/view'); ?>">
                                            <i class="fa fa-list sub-menu-margin"></i> <span class="text"> Danh sách chấm công</span>
                                        </a>
                                    </li>
                                    <li id="timekeepers_import_xls">
                                        <a class="submenu" href="<?= site_url('timekeepers/import_xls'); ?>">
                                            <i class="fa fa-list sub-menu-margin"></i> <span class="text"> Import chấm công</span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_salaries">
                                ...
                                <ul>
                                        <li id="salaries_view">
                                            <a class="submenu" href="<?= site_url('salaries/view'); ?>"><i class="fa fa-list sub-menu-margin"></i>
                                    ...
                                    <ul>
                                        ...
                                        <li id="system_settings_customer_groups"><a
                                                href="<?= site_url('system_settings/customer_groups') ?>"><i
                                                    class="fa fa-chain sub-menu-margin"></i><span
                                                    class="text"> <?= lang('customer_groups'); ?></span></a></li>
                                        <li id="system_settings_variants"><a
                                                href="<?= site_url('system_settings/variants') ?>"><i
                                                    class="fa fa-tags sub-menu-margin"></i><span
                                                    class="text"> <?= lang('Giai đoạn sản xuất'); ?></span></a></li>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    <li id="reports_index"><a href="<?= site_url('reports') ?>"><i
                                                class="fa fa-bars sub-menu-margin"></i><span
                                    ...
                                    <li id="reports_quantity_alerts"><a
                                            href="<?= site_url('reports/quantity_alerts') ?>"><i
                                                class="fa fa-bar-chart-o sub-menu-margin"></i><span
                                    ...
                                    <li id="reports_daily_sales"><a href="<?= site_url('reports/daily_sales') ?>"><i
                                                class="fa fa-calendar-o sub-menu-margin"></i><span
                                    ...
                                    <li id="reports_sales"><a href="<?= site_url('reports/sales') ?>"><i
                                                class="fa fa-heart sub-menu-margin"></i><span
                                    ...
                                    <!-- Báo cáo yêu cầu sản xuất -->
                                    <li id="reports_requirements"><a href="<?= site_url('reports/report_ycsx') ?>"><i
                                                class="fa fa-star sub-menu-margin"></i><span
                                                class="text">Báo cáo yêu càu sản xuất</span></a></li>
                                ...
                                <li class="mm_products">
                                    ...
                                    <ul>
                                        ...
                                        <?php if ($GP['products-edit']) { ?>
                                            <li id="products_quantity_adjustments"><a class="submenu"
                                                                                 href="<?= site_url('products/quantity_adjustments'); ?>"><i
                                                        class="fa fa-filter sub-menu-margin"></i><span
                                                        class="text"> <?= lang('quantity_adjustments'); ?></span></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
