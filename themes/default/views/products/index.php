        ...
        oTable = $('#PRData').dataTable({
            ...
            "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, {
                    "bSortable": false,
                    "mRender": img_hl
                }, null, null, null, null, null, {"mRender": currencyFormat},{"mRender": currencyFormat},{"bSortable": false}
            ]
            ...
            {column_number: 4, filter_default_label: "Danh mục", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('Quy cách');?>]", filter_type: "text", data: []},
            {column_number : 6, filter_default_label: "[<?=lang('Trọng lượng');?>]", filter_type: "text", data: [] },
            {column_number : 7, filter_default_label: "[<?=lang('unit');?>]", filter_type: "text", data: [] },
            {column_number: 8, filter_default_label: "[<?=lang('Giá bán');?>]", filter_type: "text", data: []},
