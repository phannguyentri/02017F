<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Thêm máy móc'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-md-12">
                ...
                echo form_open_multipart("machine/add", $attrib)
                ?>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_input('machine_code', (isset($_POST['code']) ? $_POST['machine_code'] : ($product ? $product->code : '')), 'class="form-control" id="machine_code"  required="required"') ?>
                        <!-- <span class="help-block"><?= lang('you_scan_your_barcode_too') ?></span> -->
                    </div>
                        <div class="form-group all">
                        <?= lang("Tên máy móc", "machine_name") ?>
                        <?= form_input('machine_name', (isset($_POST['machine_name']) ? $_POST['machine_name'] : ($product ? $product->name : '')), 'class="form-control" id="machine_name" required="required"'); ?>
                    </div>
                     ...
                     <div class="form-group all">
                        ...
                        echo form_dropdown('category', $cat, (isset($_POST['category']) ? $_POST['category'] : ($product ? $product->category_id : '')), 'class="form-control select" id="category" placeholder="' . lang("select") . " " . lang("Loại máy móc") . '"  style="width:100%"')
                        ?>
                    </div>
                    <div class="form-group">
                        <?php echo lang('Công suất máy', 'machine_details'); ?>
                        <div class="controls">
                        <?= form_input('machine_capacity', (isset($_POST['machine_capacity']) ? $_POST['machine_capacity'] : (isset($categories
                        ) ? $categories->machine_capacity : '')), 'class="form-control" id="machine_capacity"'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <?php echo lang('Thông số chi tiết', 'machine_details'); ?>
                        <div class="controls">
                        <?= form_input('machine_details', (isset($_POST['machine_details']) ? $_POST['machine_details'] : (isset($categories
                        ) ? $categories->machine_details : '')), 'class="form-control" id="machine_details"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <?= form_textarea('machine_note', (isset($_POST['machine_note']) ? $_POST['machine_note'] : (isset($categories
                        ) ? $categories->machine_note : '')), 'class="form-control" id="machine_note"'); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <?php echo form_submit('add', $this->lang->line("Thêm máy móc"), 'class="btn btn-primary"'); ?>
                    </div>
                    </div>
                </div>
