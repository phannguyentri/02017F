                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data[0].error) {
                                ...
                                for (key in data){
                                    if (ui.item.id !== 0) {
                                        var row = add_invoice_item(data[key], billers);
                                        if (row)
                                            $(this).val('');
                                    } else {
                                        bootbox.alert('<?= lang('no_match_found') ?>');
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="panel panel-info">
                                            ...
                                            <div class="text-center">Vui lòng cập nhật thông tin lệnh sản xuất</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Thêm lệnh sản xuất'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-md-12">
                ...
                echo form_open_multipart("productions/add", $attrib);
                if ($quote_id) {
                    echo form_hidden('quote_id', $quote_id);
                }
                ?>
<!--                 <input id="grand_total" type="hidden" name="grand_total" value="0">
 -->                <div class="col-m12">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $production->reference_no), 'class="form-control input-tip" id="slref"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo form_input('implementation_unit', (isset($_POST['implementation_unit']) ? $_POST['implementation_unit'] : $production->working), 'class="form-control input-tip" id="implementation_unit"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12" id="more" style="display: none;">
                                ...
                                <div class="row delivery_date">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('delivery_date[0][start]', (isset($_POST['delivery_date[0][start]']) ? $_POST['delivery_date[0][start]'] : $this->sma->hrsd(date("Y-m-d"))), 'class="form-control input-tip date" id="delivery_date_start0" required="required"'); ?>
                                        </div>
                                    </div>
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("Ngày giao hàng","delivery_date_end"); ?>
                                            <?php echo form_input('delivery_date[0][end]', (isset($_POST['due_date']) ? $_POST['due_date'] : $this->sma->hrsd(date("Y-m-d",strtotime("+ 7 day")))), 'class="form-control input-tip date" id="delivery_date_end0" '); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("Phần trăm giao hàng","delivery_date_end"); ?>
                                            <?php echo form_input('delivery_date[0][percent]', (isset($_POST['delivery_date[0][percent]']) ? $_POST['delivery_date[0][percent]'] : ''), 'class="form-control input-tip" id="delivery_date_percent0" '); ?>
                                        </div>
                                    </div>
                                    </div>
                                    <div id="dest"></div>
                        ...
                        <div class="col-md-12" id="sticker">
                            <div class="well well-sm" id="div-handwork">
                        ...
                        <div class="row" id="bt">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <?= lang("Ghi chú", "slnote"); ?>
                                        <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : $production->note), 'class="form-control" id="slnote" style="margin-top: 10px; height: 100px;"'); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group"><?php echo form_submit('add_sale', lang("submit"), 'id="add_sale" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
    ...
    $(document).ready(function () {
        ...
        var html="";
            ...
            html+='<div class="col-md-4"><div class="form-group"><label for="delivery_date_start'+row+'">Ngày bắt đầu</label><input type="text" name="delivery_date['+row+'][start]" value="" class="form-control input-tip date" id="delivery_date_start'+row+'" required="required"></div></div>';
             ...
             html+='<div class="col-md-4"><div class="form-group"><label for="delivery_date_percent'+row+'">Phần trăm giao hàng</label><input type="text" name="delivery_date['+row+'][percent]" value="" class="form-control input-tip" id="delivery_date_percent'+row+'" required="required"></div></div></div>';
            $('#dest').append(html);
