<script>
    $(document).ready(function () {
        function trangthai(x){
            if (x == 0) {
              return  '<div class="text-center"><span class="label label-warning">Chưa thu đủ</span></div>';
            }else if(x == 1){
              return  '<div class="text-center"><span class="label label-success">Đã thanh toán</span></div>';
            }
        }
        ...
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('productions/getProductions') ?>',
            ...
            {column_number: 4, filter_default_label: "[<?=lang('Ngày giao hàng');?>]", filter_type: "text", data: []},
            // {column_number: 5, filter_default_label: "[Trạng thái sản xuất]", filter_type: "text", data: []},
        ], "footer");
...
<?php if ($Owner) {
    echo form_open('productions/production_actions', 'id="action-form"');
} ?>
<div class="box">

    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('Danh sách lệnh sản xuất'); ?>
        </h2>
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <!-- <th>Ngày bắt đầu - Ngày giao hàng</th> -->
                        ...
                        <tr class="active">
                            ...
                            <th><?php echo $this->lang->line("paid"); ?></th>
                            <th><?php echo $this->lang->line("balance"); ?></th> -->
                            <th><?php echo $this->lang->line("productions_status"); ?></th>
                            <th style="width:80px; text-align:center;"><?php echo $this->lang->line("actions"); ?></th>
                        </tr>
                        </tfoot>
                    </table>
