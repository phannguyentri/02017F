...
<script>
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('enquiry/getEnquiry' . ($warehouse_id ? '/' . $warehouse_id : '')) ?>',
...
<?php if ($Owner) {
    echo form_open('enquiry/enquiry_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-star"></i><?= lang('enquiry') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
