...
// localStorage.removeItem('poitemss');
        ...
        $("#add_item").autocomplete({
            source: '<?= site_url('enquiry/suggestions'); ?>',
            minLength: 1,
            autoFocus: false,
            delay: 200,
            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
                    console.log(ui.item);
                    var row = add_enquiry_item(ui.item);
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_enquiry'); ?></h2>
    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "podate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : $this->sma->hrsd($date)), 'class="form-control input-tip date" id="date" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Số mua hàng</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                $post = array('approve' => lang('approve'), 'approval' => lang('approval'));
                            ...
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls">
                                    <table id="poTable"
                                        ...
                                        <thead>
                                        <tr>
                                            <th class="col-md-4"><?= lang("product_name") . " (" . $this->lang->line("product_specification") . ")"; ?></th>
                                            <?php
