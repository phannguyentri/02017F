<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //localStorage.setItem('posupplier', '<?=$inv->supplier_id?>');
        localStorage.setItem('poitemss', JSON.stringify(<?=$inv_items;?>));
        <?php } ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_enquiry'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("enquiry/edit/" . $inv->id, $attrib)
                ?>
