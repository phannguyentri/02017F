<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-file"></i><?= lang("Mã yêu cầu mua hàng") . '. ' . $inv->id; ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<?= site_url('enquiry/edit/' . $inv->id) ?>"><i
                                    class="fa fa-edit"></i> <?= lang('edit_enquiry') ?></a></li>
                        
                        <li><a href="<?= site_url('enquiry/pdf/' . $inv->id) ?>"><i
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:middle;"><?= $row->product_name . " (" . $row->specification . ")" . ($row->variant ? ' (' . $row->variant . ')' : ''); ?>
            ...
            <div class="buttons">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group"><a href="#" class="tip btn btn-danger bpo"
                                              ...
                                              data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= site_url('enquiry/delete/' . $inv->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
