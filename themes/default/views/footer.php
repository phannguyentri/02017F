...
<footer><a href="#" id="toTop" class="blue"
    ...
    <p style="text-align:center;">&copy; <?= date('Y') . " " . CompanyName; ?> ( www.google.com
...
<?= ($m == 'enquiry' && ($v == 'add' || $v == 'edit' || $v == 'enquiry_by_csv')) ? '<script type="text/javascript" src="' . $assets . 'js/enquiry.js"></script>' : ''; ?>

<?= ($m == 'transfers' && ($v == 'add' || $v == 'edit')) ? '<script type="text/javascript" src="' . $assets . 'js/transfers.js"></script>' : ''; ?>
<?= ($m == 'productions' && ($v == 'add' || $v == 'edit')) ? '<script type="text/javascript" src="' . $assets . 'js/sales.js"></script>' : ''; ?>
