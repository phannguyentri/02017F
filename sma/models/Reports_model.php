...
class Reports_model extends CI_Model
{
    ...
    public function Getycsx()
    {
       
        $this->db->select('id,DATE_FORMAT(date, "%Y-%m-%d") as month,sale_status,total');
       
        // $this->db->select_sum('productions.grand_total');
        $this->db->where('productions.sale_status','pending');
        // $this->db->select_sum('(total_revenue-total_pur) as loinhuan');
